...
module.exports = (() => {
    ...
    return !global.ZeresPluginLibrary ? class {
        ...
        const plugin = (Plugin, Api) => {
            ...
            return class NitroXPlus extends Plugin {
                defaultSettings = {
                    "emojiSize": 48,
                    "screenSharing": true,
                    "emojiBypass": true,
				...
				emojiBypassForValidEmoji(emoji, currentChannelId){ //Made into a function to save space & clean up
                ...
                saveAndUpdate() {
                    ...
                    if (this.settings.emojiBypass) {
						...
						if(this.settings.uploadEmotes){
								...
								BdApi.Patcher.unpatchAll("NitroXPlus", DiscordModules.MessageActions);
								BdApi.Patcher.instead("NitroXPlus",DiscordModules.MessageActions, "sendMessage", (_, [, msg], send) => {
					...
					if(!this.settings.uploadEmotes) BdApi.Patcher.unpatchAll("NitroXPlus", DiscordModules.MessageActions)
					
					//Stupid Settings Prevention
                ...
                onStop() {
                    ...
                    Patcher.unpatchAll();
					BdApi.Patcher.unpatchAll("NitroXPlus");
					this.restoreFPS();
                }
            };
        };
